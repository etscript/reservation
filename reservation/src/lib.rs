...
pub trait Rsvp {
    // make a reservation
    async fn reserve(&self, reservation: abi::Reservation) -> Result<abi::Reservation, ReservationError>;
    ...
    // update reservation
    async fn update(&self, id: ReservationId, note: String) -> Result<abi::Reservation, ReservationError>;
    // delete reservation
